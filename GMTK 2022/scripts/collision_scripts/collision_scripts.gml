...
///@func	tile_passable()
///@desc	Checks a given tile CELL based on x/y CELL coords and returns true if the tile is passable
///@param	_tilemap
///@param	_cellx
///@param	_celly
function tile_passable(_tilemap,_cellx,_celly){
#region
var _tdata = tilemap_get(_tilemap,_cellx,_celly);
var _tindex = tile_get_index(_tdata);
// Check tile indexes based on tilemap provided
